...
//   "2018;100-B(8):991-1001"     a lettered volume, as the Bone & Joint Journal
//                                numbers them — and Crossref stores it that way
//                                too, so the suffix is kept
//
...
const LOCATOR_SRC =
  ...
  '(?<vol>[A-Za-z]?[\\dA-Za-z]{0,8}?(?:-[A-Za-z]{1,2})?)' +
